...
- [Coding Guidelines](./coding-guidelines.md) — Conventions for imports, function definitions, functional style, constants, JSDoc, file layout, naming, tests, error handling, and comments.
